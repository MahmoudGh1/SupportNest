...
ALTER TYPE "AgentAction" ADD VALUE IF NOT EXISTS 'ESCALATED_TO_TIER0';
ALTER TYPE "AgentAction" ADD VALUE IF NOT EXISTS 'ESCALATED_TO_TIER1';
ALTER TYPE "AgentAction" ADD VALUE IF NOT EXISTS 'ESCALATED_TO_TIER2';