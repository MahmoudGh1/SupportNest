...
function connect() {
	...
	// Explicitly append the path your server expects
...
function handleEvent(msg) {
	...
	switch (type) {
		...
		case "conversation_closed":
			appendSystemMessage(
				"This conversation has ended. Send a message anytime to start a new one — we're here to help.",
			);
			break;
...
class RatingWidget {
	...
	async handleStarClick(e) {
		...
		this.updateFeedback(this.config.labels[rating] || `${rating} stars`, true);
