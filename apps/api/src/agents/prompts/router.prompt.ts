...
- Examples when preferLiveFollowup could be activated and a route to tier1 is expected:
			Ex: "What pets are available?" 
			Ex: "What's my order status?"
			Ex: "Show me the inventory."
