...
export async function tier1AgentController(req: Request, res: Response): Promise<void> {
	...
	try {
		...
		const result = await runTier1Agent(question.trim(), organizationId, conversationId, customerId, conversationHistory);
