...
export const sendInvitationController: RequestHandler = asyncHandler(
...
export const validateInvitationController: RequestHandler = asyncHandler(
	async (req, res) => {
...
export const acceptInvitationController: RequestHandler = asyncHandler(
	async (req, res) => {
		const { token } = req.params;
...
export const getTeamController: RequestHandler = asyncHandler(
	async (req: AuthenticatedRequest, res) => {
		const organizationId = req.user?.organizationId;
...
export const revokeInvitationController: RequestHandler = asyncHandler(
	async (req: AuthenticatedRequest, res) => {
		const organizationId = req.user?.organizationId;
		const { id } = req.params;
