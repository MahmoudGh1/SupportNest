			...
			<div>
						...
						>
							<div
								style={{
									...
									background:
										i < step ? S.green : i === step ? S.purple : S.border,
									fontSize: 12,
									fontWeight: 600,
							...
							{i < 3 && (
								<div
									style={{
										flex: 1,
										height: 2,
										background: i < step ? S.green : S.border,
										borderRadius: 1,
				...
				{step === 1 && (
					<div>
						...
						<p
							style={{ margin: "0 0 24px", fontSize: 13, color: S.textMuted }}
						>
							Tell us about your business so we can configure your workspace.
						</p>
						<Input
								...
								{industries.map((ind) => (
									<button
										...
										style={{
											...
											color:
												form.industry === ind ? S.purple : S.textSecondary,
											fontSize: 13,
											cursor: "pointer",
											fontFamily: "inherit",
								...
								>
									...
									{form.size === sz && (
										<i
											...
											style={{ fontSize: 18, color: S.purple }}
										/>
									)}
								</button>
							))}
				...
				{step === 3 && (
					<div>
							...
							{[
								...
								>
									...
									<div>
										...
										<div
											style={{ fontSize: 13, fontWeight: 500, color: S.dark }}
										>
											{row.value}
										</div>
									</div>
						...
						>
							...
							/>
							<span>
								Your AI pipeline (Router → Tier 1 → Tier 2 → Human) will be
