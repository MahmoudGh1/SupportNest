...
const testimonial = {
  quote: "SupportNest is a game changer. Their AI handles our customers and only escalates what truly needs a human. Our team finally has time to breathe.",
...
function FormField({ label, type = "text", value, onChange, placeholder, error, autoComplete, rightEl, labelRight }: FieldProps) {
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden style={{ opacity: 0.3 }}>
          ...
          <FormField
            ...
            labelRight={
              <button style={{
                ...
                fontSize: 13, color: T.violetLight,
            ...
            rightEl={
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: T.gray500, padding: 0, display: "flex" }}
              >
          ...
          >
            {loading
              ? <><i className="ti ti-loader-2" style={{ fontSize: 16, animation: "spin 0.8s linear infinite" }} /> Signing in…</>
              : "Sign in"
            }
          </button>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: T.gray500, margin: 0 }}>
            ...
            <button
              ...
              style={{
                background: "none", border: "none",
                color: T.violetLight, fontSize: 13,
        ...
        <p style={{
          ...
          <button style={{ background: "none", border: "none", color: "rgba(255,255,255,0.35)", fontSize: 11, cursor: "pointer", fontFamily: T.font, padding: 0 }}>Terms of Service</button>
          {" "}and{" "}
          <button style={{ background: "none", border: "none", color: "rgba(255,255,255,0.35)", fontSize: 11, cursor: "pointer", fontFamily: T.font, padding: 0 }}>Privacy Policy</button>
