...
function OrganizationsTab() {
 ...
 if (selectedOrgId) {
     return <div className="org-detail-container" style={{ animation: "fadeIn .4s cubic-bezier(0.4, 0, 0.2, 1)" }}><OrganizationDetail organizationId={selectedOrgId} onClose={() => setSelectedOrgId(null)} /></div>;
 }
