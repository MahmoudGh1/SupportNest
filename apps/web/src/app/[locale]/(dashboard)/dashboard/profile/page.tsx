	...
	return (
		...
		>
			<div style={{ marginBottom: 20 }}>
				<h3
					style={{ margin: 0, fontSize: 15, fontWeight: 600, color: S.dark }}
				>
					{title}
				</h3>
				{subtitle && (
			...
			>
				...
				<button
					...
					style={{
						...
						padding: "11px 0",
						borderRadius: 9,
						background: copied ? S.greenBg : S.purpleBg,
						border: `1.5px solid ${copied ? S.green : S.purple}`,
						color: copied ? "#0F6E56" : S.purple,
						fontSize: 14,
						fontWeight: 600,
						cursor: "pointer",
						fontFamily: "inherit",
					...
					keys.map((key, i) => (
						<div
							...
							style={{
								...
								background: key.is_active ? "#fff" : S.bg,
			...
			<div style={{ display: "flex", alignItems: "center", gap: 10 }}>
				...
				>
					<i
						...
						style={{ fontSize: 15, color: S.purple }}
					/>
				</div>
				<span style={{ fontSize: 13, color: S.textMuted, fontWeight: 500 }}>
					{label}
				</span>
			</div>
			{badge ? (
				...
				<span style={{ fontSize: 13, fontWeight: 500, color: S.dark }}>
					{value}
				</span>
			)}
		</div>
				...
				<div style={{ display: "flex", alignItems: "center", gap: 10 }}>
					...
					>
						<i
							...
							style={{ fontSize: 15, color: "#0F6E56" }}
						/>
					</div>
					<span style={{ fontSize: 13, color: S.textMuted, fontWeight: 500 }}>
						Account status
