		...
		<div className="flex flex-col h-full bg-white">
			...
			<div className="px-6 py-4 border-b border-[#e8e6f0] shrink-0">
				<div className="flex items-center justify-between">
					<div>
						<h1 className="text-[17px] font-bold text-[#1a1830]">
							Ticket Inbox
						</h1>
			...
			<div className="flex flex-1 min-h-0 overflow-hidden">
				{/* Left — ticket list */}
				<div
					className={`border-r border-[#e8e6f0] overflow-y-auto shrink-0 ${selected ? "w-[320px]" : "flex-1"}`}
				>
					{loading ? (
						...
						<div className="px-5 py-8 text-center">
							...
							<button
								onClick={() => fetchTickets(activeTab)}
								className="text-[13px] text-[#534AB7] font-semibold"
							>
								Try again
							</button>
						</div>
