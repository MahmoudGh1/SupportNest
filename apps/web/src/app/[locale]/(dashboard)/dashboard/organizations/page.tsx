...
import type { AdminOrganizationsResponse } from "@/types/types";
...
export default function OrganizationsPage() {
	...
	const renderOrganizations = () => (
		...
		>
			...
			>
				<h2
					style={{ fontSize: 16, color: S.dark, margin: 0, fontWeight: 700 }}
				>
					...
					<tbody>
						{orgs?.data.map((org) => (
							...
							>
								<td style={cellStyle}>
									<div
										style={{ color: S.dark, fontWeight: 650, fontSize: 13 }}
									>
										{org.name}
									</div>
								...
								<td style={cellStyle}>
									{formatNumber(org.stats.total_users)}
								</td>
								<td style={cellStyle}>
									{formatNumber(org.stats.total_tickets)}
								</td>
								<td style={cellStyle}>
									<span
										style={{
											color:
												org.stats.escalated_tickets > 0
													? S.danger
													: S.textSecondary,
