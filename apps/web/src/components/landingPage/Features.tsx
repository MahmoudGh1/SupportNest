		...
		>
			<div className="max-w-[1100px] mx-auto">
				<div className="text-center mb-14">
					...
					<p className="text-base sn-muted max-w-[480px] mx-auto m-0">
						<Trans>
				...
				<div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-4">
					{FEATURES.map((f) => (
						<div
							key={f.title}
							className="sn-surface rounded-2xl p-6 border transition-transform hover:-translate-y-0.5"
						>
							<div
							...
							<div className="text-[13px] sn-muted leading-[1.65]">{f.desc}</div>
						</div>
					))}
				</div>
			</div>
