      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-14 md:mb-[72px]">
          ...
          >
            ...
            <p className="text-[15px] sn-muted leading-[1.8] mt-0 mb-4">
            ...
            <p className="text-[15px] sn-muted leading-[1.8] m-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {VALUES.map((v, i) => (
            ...
            >
              ...
              <div className="text-sm font-bold sn-page-text mb-2">{v.title}</div>
              <div className="text-[13px] sn-muted leading-[1.65]">{v.desc}</div>
            </div>
          ))}
        </div>
      </div>
