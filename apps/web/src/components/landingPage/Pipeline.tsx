      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <p className="text-sm sm:text-base sn-muted max-w-[520px] mx-auto m-0">
            Four layers of intelligence — each one smarter than the last. 80% of
            tickets never reach a human.
          </p>
        </div>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: tier.featured
                  ? "0 12px 40px rgba(83,74,183,0.25)"
                  : "none",
              }}
            >
              {tier.featured && (
              ...
              {/* Arrow connector — horizontal on lg, hidden on smaller grids */}
              {i < TIERS.length - 1 && (
