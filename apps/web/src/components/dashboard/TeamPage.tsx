						...
						members.map((member, i) => (
							<div
								...
								style={{
									...
									padding: "14px 20px",
									borderBottom:
										i < totalRows - 1 ? `1px solid ${T.darkBorder}` : "none",
									alignItems: "center",
							...
							>
								...
								>
									...
									<div>
										<div
											style={{ fontSize: 14, fontWeight: 500, color: T.White }}
										>
								...
								>
									...
									<div>
										...
										>
											...
											{inv.invitedBy.lastName} · Expires{" "}
