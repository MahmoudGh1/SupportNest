...
export function OnboardingEmptyState({ onNavigate }: OnboardingEmptyStateProps) {
	return (
		<div style={{ padding: "2rem", maxWidth: 860, margin: "0 auto" }}>
				...
				{STEPS.map((step) => (
					...
					>
						...
						<div style={{ flex: 1, minWidth: 0 }}>
							...
							<div
								style={{ fontSize: 14, fontWeight: 600, color: S.dark, marginBottom: 2 }}
							>
								{step.title}
							</div>
			...
			>
				...
				/>
				Once customers start chatting, your analytics will appear here — resolution
				rates, CSAT scores, response times, and more.
			</div>
		</div>
	);
}